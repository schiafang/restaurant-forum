    ...
    Restaurant.findAndCountAll({ include: Category, where: selectCategory, offset, limit: pageLimit })
      .then(result => {
        ...
        Category.findAll({ raw: true, nest: true })
          .then(categories => {
            return callback({ categories, categoryId, restaurants, page, totalPage, prev, next })
          })
      })
  },
  getRestaurant: (req, res, callback) => {
    ...
    return Restaurant.findByPk(id, {
      ...
      .then(restaurant => {
        ...
        return callback({ restaurant, isFavorited, isLike, likeCount })
      })
  },
  ...
  getDashboard: (req, res, callback) => {
    ...
    Restaurant.findByPk(id, { include: [Category, Comment, { model: User, as: 'FavoritedUsers' },] })
      .then(restaurant => {
        ...
        return callback({ restaurant, countComments, countFavoritedUsers })
      })
  },
